...
def main():
    ...
    for epoch in range(0, training_epochs):
        if epoch in [training_epochs*2//3,training_epochs*5//6]:
        ...
        if valid_accuracy>best_acc:
            ...
            #torch.save(model,os.path.join(save_path,'test_useresize_{}_size_{}.pth'.format(args.model,args.resize_val)))
        print('valid_epoch:{}, valid_loss:{:.4f},valid_accuracy:{:.4f},Best_acc:{:.4f},size:{}'.format(epoch, valid_loss, valid_accuracy,best_acc,args.resize_val))
