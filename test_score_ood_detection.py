...
valid_loss, valid_correct, valid_accuracy = valid(net, train_loader,args.num_class)
...
if args.score == 'ReAct':
    args.threshold = get_threshold(p=0.98) 
...
def get_and_print_results(ood_loader, num_to_avg=args.num_to_avg,ood_name=""):
    ...
    for _ in range(num_to_avg):
        ...
        score_np = in_score.tolist() + out_score.tolist()
        tf_np = [1 for i in range(len(in_score))] + [0 for i in range(len(out_score))]
        if os.path.exists('csv_conv/{}_{}_{}_{}.csv'.format(args.dataset,args.model,args.score,ood_name)):
            os.remove('csv_conv/{}_{}_{}_{}.csv'.format(args.dataset,args.model,args.score,ood_name))
        np.savetxt('csv_conv/{}_{}_{}_{}.csv'.format(args.dataset,args.model,args.score,ood_name), np.stack([np.array(score_np),np.array(tf_np)],1), fmt='%.4f')
...
print('\n\nSVHN Detection')
fpr,auc = get_and_print_results(ood_loader=ood_loader,ood_name="SVHN")
fprlist.append(fpr)
auclist.append(auc)
...
ood_loader = torch.utils.data.DataLoader(ood_data, batch_size=args.batch_size, shuffle=True,
                                         num_workers=2, pin_memory=True)
print('\n\nLSUN_C Detection')
fpr,auc = get_and_print_results(ood_loader=ood_loader,ood_name="LSUN_C")
fprlist.append(fpr)
auclist.append(auc)
# # # /////////////// LSUN-R ///////////////
...
fpr,auc = get_and_print_results(ood_loader=ood_loader,ood_name="LSUN_R")
fprlist.append(fpr)
auclist.append(auc)
...
ood_loader = torch.utils.data.DataLoader(ood_data, batch_size=args.batch_size, shuffle=True,
                                         num_workers=2, pin_memory=True)
print('\n\nPlaces365 Detection')
fpr,auc = get_and_print_results(ood_loader=ood_loader,ood_name='Places')
fprlist.append(fpr)
auclist.append(auc)
...
ood_loader = torch.utils.data.DataLoader(ood_data, batch_size=args.batch_size, shuffle=True,
                                         num_workers=2, pin_memory=True)
print('\n\nTexture Detection')
fpr,auc = get_and_print_results(ood_loader=ood_loader,ood_name='DTD')
fprlist.append(fpr)
auclist.append(auc)
...
fpr,auc = get_and_print_results(ood_loader=ood_loader,ood_name='tiny_imagenet')
fprlist.append(fpr)
auclist.append(auc)
...
ood_loader = torch.utils.data.DataLoader(ood_data, batch_size=args.batch_size, shuffle=True,
                                         num_workers=2, pin_memory=True)
print('\n\nSUN Detection')
fpr,auc = get_and_print_results(ood_loader=ood_loader,ood_name='SUN')
fprlist.append(fpr)
auclist.append(auc)
...
fpr,auc = get_and_print_results(ood_loader=ood_loader,ood_name='iNaturalist')
fprlist.append(fpr)
auclist.append(auc)
